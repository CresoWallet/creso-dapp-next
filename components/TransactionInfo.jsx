...
//     <div className="relative">
//       {popupVisible && (
//         <div className="fixed top-0 right-0 bottom-0 left-0 bg-black/40 z-[1]" onClick={handleClosePopup}></div>
//       )}
...
//       <IoIosClose
//         className={`text-white h-7 w-7 absolute top-2 right-2 cursor-pointer ${popupVisible ? "z-[2]" : ""}`}
//         onClick={handleClosePopup}
//       />

//       <div className={`flex xl:flex-nowrap flex-wrap justify-between items-center ${popupVisible ? "opacity-50 pointer-events-none" : ""}`}>
