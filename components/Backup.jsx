    ...
    <div className="col-span-2 space-y-4">
      <div className="flex flex-col space-y-2">
        ...
        <p className="xl:text-sm md:text-xs text-xs">
          Soory, you are unable to proceed until you complete the
          backup. Backup now to secure your account.
        </p>
      </div>
      <div className="flex justify-center">
        <button onClick={props.onClick} className="text-white bg-[#FF4085] xl:py-3 md:py-3 py-1 rounded-full w-full text-center">
          Backup
        </button>
      </div>
    </div>
