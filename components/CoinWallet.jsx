...
const CoinWallet = ({ handleClose, wallets, show }) => {
  ...
  return (
    <div className={`absolute bg-white md:border-l-2 xl:border-l-2 md:shadow-xl xl:shadow-xl w-full h-full z-10 ${!show && 'hidden'}`}>
