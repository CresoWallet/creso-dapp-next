        ...
        <div className="flex flex-col xl:space-y-4  space-y-4 xl:pt-6 md:pt-3  pt-2 ">
          {links.map(({ id, label, icon: Icon }) => (
            ...
            >
              {id === "session2" ? (
                <div
                  className={`flex flex-row justify-between items-center mx-4 text-black cursor-not-allowed ${hover === id || clicked === "/" + id ? "text-purple-800 font-bold" : ""
                    } `}
                ...
                >
                  <a
                    className={`flex flex-row gap-2 items-center ${hover === id || path === "/" + id ? "text-purple-800 font-bold" : ""
