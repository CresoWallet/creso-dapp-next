...
const SessionPage = () => {
  ...
  return (
    <>
      {
        navbarTrigger && <div className="navbackdrop" onClick={() => setNavbarTrigger(!navbarTrigger)}>
      ...
      <div className="grid xl:grid-cols-2 md:grid-cols-2 grid-cols-1">
        <div className="col-span-1">
          ...
          <div className="flex xl:hidden md:hidden justify-center gap-4">
            ...
            {
              !isMobile && <div className={`col-span-1 h-full`}>
                <SideNav />
              </div>
            }
            {
              isMobile && <div className="account-navs"><Image alt="" className="navico" src={Ham} onClick={() => setNavbarTrigger(!navbarTrigger)} /> </div>
            }

            <div className={`col-span-2 ${isMobile ? 'mt-2' : 'mt-16'} xl:mx-8 md:mx-4 mx-2`}>
              <Account />
            </div>
          </div>
        </div>
        <div className="col-span-1 xl:mx-8 md:mx-4 mx-2 xl:mt-10 mt-4">
          <div className="flex flex-row justify-between items-center mx-8 mt-8">
            <p className="xl:text-xl md:text-xl text-lg  font-semibold">V1 Sessions</p>
