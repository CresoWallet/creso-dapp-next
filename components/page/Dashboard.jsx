...
const Dashboard = () => {
    ...
    const [swalletTotalBalance, setSwalletTotalBalance] = useState(0);
    const [eoawalletTotalBalance, setEoawalletTotalBalance] = useState(0);
        ...
        const computeWallet = async (data) => {
            let walletsEOA = await Promise.all(
                data.wallets.map(async (wallet, index) => {
                    ...
                    walletsEOASum += balance;

                    setEoawalletTotalBalance(
                        eoawalletTotalBalance + eoawalletTotalBalance
                    );
                    return {
            ...
            setEoawalletTotalBalance(parseFloat(walletsEOASum));
            ...
            setSwalletTotalBalance(walletsSSum);
                ...
                <div className="col-span-2">
                    <div className="grid h-full responsivemb-cols">
                        {isMobile && navbarTrigger && (
                            <div
                                className={`col-span-1 h-full responsivemb-nav `}
                            >
                                <SideNav />
                            </div>
                        )}
                        ...
                        <div className="col-span-3 xl:space-y-6 md:space-y-6 space-y-2 xl:mx-10 md:mx-4 xl:py-8 md:py-8">
                            <div className="flex xl:hidden md:hidden">
                                {showWallet && (
                                    <CreateWallet handleClose={handleClose} />
                                )}
                            </div>
                            <div className="flex xl:hidden md:hidden">
                                {/* {showCoinWallet && ( */}
