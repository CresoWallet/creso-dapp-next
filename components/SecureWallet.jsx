...
const SecureWallet = ({
  ...
  return (
    <div
      className={`bg-white shadow-xl lg:w-auto h-[100vh] lg:block`}
    >
      <div className="grid place-items-center rounded-full bg-black h-8 w-8 absolute cursor-pointer md:-ml-4 ml-2 -mt-10 lg:mt-0 z-[99]">
