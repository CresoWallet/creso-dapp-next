  ...
  return (
    <div className="grid xl:grid-cols-2 md:grid-cols-2 grid-cols-1 h-screen mx-2 my-2 gap-2 xl:gap-0 md:gap-0">
      ...
      <div className="col-span-1 space-y-8 xl:px-24 px-4 flex flex-col xl:py-8 md:py-8">
        <p className="font-bold md:text-2xl xl:text-4xl xl:mb-4 md:mb-4 text-xl">Register</p>
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2">
            <CustomButton name="Sign up" bgColor="black" />
            <CustomButton
              bgColor="white"
          ...
          <div className="flex justify-center">
            <p className="text-sm text-[#A09FAA]">
              ...
              <Link href="/login">
                <span className="text-[#FF4085] cursor-pointer hover:font-bold">Login</span>
              </Link>
            </p>
          </div>
        </div>
