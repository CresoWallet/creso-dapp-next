...
//               <Link key={network.id} href="/networkPage">
//                 <div className="md:flex items-center justify-between hover:-translate-y-1 hover:font-semibold cursor-pointer">
//                   <div className="flex flex-row items-center gap-2 mb-2 md:mb-0">
//                     <Image alt="" src={network.icon} />
//                     <p>{network.name}</p>
//  {/* Add the specified element for Polygon */}
//  {network.id === 'polygon' && (
...
//                   </div>
//                 </div>
//                 <hr className="text-[#A09FAA] py-4 ml-12" />
//               </Link>
//             ))}
//           </div>
//         </div>
