...
//   const { name, symbol, rpcURL, blockExplorerURL } = networkDetails;

//   const getNetworkIcon = (networkName) => {
//     switch (networkName) {
//       case 'Bitcoin':
//         return '/path/to/bitcoin-icon.png';
//       case 'Ethereum':
...
//           <div className="flex flex-col space-y-1">
//             <p className="text-sm font-semibold">RPC URL</p>
//             <p className="text-xs text-[#A09FAA]">{rpcURL}</p>
//           </div>
//           <RiArrowRightSLine />
//         </div>
//       </Link>
...
//       <div className="flex flex-col space-y-1">
//         <p className="text-sm font-semibold">Network Name</p>
//         <p className="text-xs text-[#A09FAA]">{name}</p>
//       </div>
//       <hr className="text-[#A09FAA]" />
//       <div className="flex flex-col space-y-1">
//         <p className="text-sm font-semibold">Symbol</p>
//         <p className="text-xs text-[#A09FAA]">{symbol}</p>
//       </div>
//       <hr className="text-[#A09FAA]" />
//       <div className="flex flex-col space-y-1">
//         <p className="text-sm font-semibold">Block Explorer URL</p>
//         <p className="text-xs text-[#A09FAA]">{blockExplorerURL}</p>
//       </div>
//     </div>
//   );
// };
...
//   const commonNetworkDetails = {
//     rpcURL: "Blockstream.info",
//     blockExplorerURL: "Blockstream.info",
//   };

//   const networks = [
//     { name: "Bitcoin", symbol: "BTC", ...commonNetworkDetails },
//     { name: "Ethereum", symbol: "ETH", ...commonNetworkDetails },
//     { name: "BSC", symbol: "BSC", ...commonNetworkDetails },
//     { name: "Polygon", symbol: "MATIC", ...commonNetworkDetails },
//     { name: "Avalanche", symbol: "AVAX", ...commonNetworkDetails },
//     { name: "Optimism", symbol: "OP", ...commonNetworkDetails },
//   ];
...
//                     className="w-8 h-8"
//                   />
//                   <p className="text-xl font-semibold">{network.name}</p>
//                 </div>
//               </div>

//               <NetworkDetails networkDetails={network} />
//             </div>
//           ))}
//         </div>
//       </div>
